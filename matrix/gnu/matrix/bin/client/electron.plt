...
set table "/home/denis/Workspace/gnupl-elec/gnu/matrix/bin/data/data1.txt"
splot v(x,y) w l ls 1
unset table
# positron
set cntrparam levels discrete \
    0.36,0.38,0.42,0.45,0.5,0.55,0.63,0.71,0.83,1,1.25,1.67,2.5,5
set table "/home/denis/Workspace/gnupl-elec/gnu/matrix/bin/data/data2.txt"
splot v(x,y) w l ls 1
unset table

# Draw positron and electron
call "/home/denis/Workspace/gnupl-elec/gnu/matrix/bin/client/gnu/electron.gnu" x1 y1 '0.1'
call "/home/denis/Workspace/gnupl-elec/gnu/matrix/bin/client/gnu/electron.gnu" x2 y2 '0.1'
plot "/home/denis/Workspace/gnupl-elec/gnu/matrix/bin/data/data1.txt" u 1:2 w l ls 1, \
     "/home/denis/Workspace/gnupl-elec/gnu/matrix/bin/data/data2.txt" u 1:2 w l ls 2
